<template>
  <div>
    <!-- Summary Card -->
    <div class="row">
      <div class="col-lg-3 col-sm-6" v-for="summary in summaryCard" :key="summary.text">
        <summary-card>
          <div class="col-md-3 absiconcard" :class="summary.color" slot="header">
            <i :data-feather="summary.icon"></i>
          </div>
          <div class="numbers" slot="content">
            <p class="card-title col-sm-7 offset-md-5 float-right">{{summary.text}}</p>
            <br>
...
import SummaryCard from "~/components/UIComponents/Cards/SummaryCard.vue";
let Chartist;
...
export default {
  ...
  methods:{
    async fetchSomething () {
      const ip = await this.$axios.$get('http://127.0.0.1:8000/api/attendance_users');
      console.log(ip);
    }
  } 
};
